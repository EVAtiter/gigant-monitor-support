...
壁モードからギザギザモードへの**移行段階**。左半分はまだ滑らかな液体の壁を保ったまま、右端から鋸状の波形が生え始める。80% の「千切れる直前」と 85% の「全面ギザギザ」の中間で、メタボール表現が崩れ始める瞬間が見える。

### 85%
![85%](85.jpg)

鋸状波形が画面全体に行き渡る。82% の右端から始まったギザギザがいよいよ全幅に広がり、上下から黄色が交互に食い込んで紫の帯を浸食する。中央の紫帯はまだ太めで、95% より振幅が落ち着いている「ギザギザ初期」の姿。これより上は「眺めて楽しい」過負荷表現の領域。
